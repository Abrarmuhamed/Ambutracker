...
$_SESSION["driver_phone"] = "9072131343";
if (isset($_SESSION["driver_phone"])) {
    header("Location: /");
}
        ...
        <div class="row h-100vh justify-content-center align-items-center m-0" id="sign-up-card">
            <div class="col-md-4">
                <div class="sign-content">
                    ...
                    ?>
                    <?php if (!isset($_SESSION["driver_otp"]) && !isset($_SESSION["otp-verified"])) { ?>
                        <div id="number-div">
                            <img src="assets/images/ambulance.svg" class="img-fluid mb-3" width="225">
                            <h5 class="text-theme fw-bold mb-0 mt-3">Hey Gorgeous!</h5>
                            <p class="text-theme-2 fs-12 mt-1">“Speed does not always kill. And not only that,<br>sometimes speed saves a life.”</p>
                    ...
                    ?>
                        <div id="otp-div">
                            ...
                            <p class="text-theme-2 fs-12 mt-1 mb-1">We have sent an OTP to <span class="text-theme">+91 <?php echo $_SESSION['driver_ref_phone']; ?></span>
                            </p>
                        ...
                        <div id="otp-div">
                            ...
                            <form action="functions/functions.php" method="post">
                                ...
                                <div class="mb-3 text-start">
                                    ...
                                    <input type="text" class="form-control fs-12" id="vno" name="vno" placeholder="Enter Your Vehicle Number" aria-label="Vehicle Number" required>
                                </div>
